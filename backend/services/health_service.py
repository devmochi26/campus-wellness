...
from models import User, DailyRoutine, DietRecord, ExerciseRecord, MoodRecord, ConstitutionTest, StressAssessment, Habit, HabitCheckin
...
def get_risks(db: Session, user_id: int) -> dict:
    today = datetime.date.today()
    week_ago = today - datetime.timedelta(days=6)
    risks = []
